# Nexus Core — Source: Test Infrastructure + Fixtures

Testing helpers and fixture data.

---
## src/testing/fixtures/context.ts
```typescript
/**
...
---
## src/testing/fixtures/routes.ts
```typescript
/**
...
---
## src/testing/helpers/test-server.ts
```typescript
/**
